				...
				<div class="u-text">
					...
					<table class="professors">
						...
						<tr>
							...
							<td class="title"> <strong>Title</strong>
							</td>
							<td class="major">
								<strong>Major</strong>
							</td>
							<td class="dir">
								<strong>Research Dirction</strong>
							</td>
							<td class="phd">
								<strong>PHD supervisor &amp; Master's supervisor</strong>
							</td>
						</tr>
						<tr>
							<td>Luo Yicheng</td>
						...
						<tr>
							...
							<td>Journalism, Communication</td>
							<td>
								Network Communication, Comparison of Chinese and Western news
							</td>
							<td>PHD supervisor, Master's supervisor</td>
						</tr>
						<tr>
					...
					<h3 id="managIns">Management&nbsp;&nbsp;Institution</h3>
					<h4>Party and Administration Office</h4>
					<table class="partyOffice">
						<tr>
							<td class="post">
								<strong>Post</strong>
							</td>
					...
					<h4>Undergraduate Office</h4>
					<table class="underOffice">
						<tr>
							<td class="post">
								<strong>Post</strong>
							</td>
					...
					<h4>Postgraduate Office</h4>
					<table class="postOffice">
						<tr>
							<td class="post">
								<strong>Post</strong>
							</td>
					...
					<h4>Educational Development and Training Office</h4>
					<table class="educationOffice">
						<tr>
							<td class="post">
								<strong>Post</strong>
							</td>
					...
					<h3 id="supportIns">Supporting Institution</h3>
					<h4>Experimental Teaching Demonstration Center</h4>
					<table class="experCenter">
						<tr>
							<td class="post">
								<strong>Post</strong>
							</td>
