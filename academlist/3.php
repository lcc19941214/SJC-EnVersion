...
<body>
	<div id="g-container">
		...
		<div id="g-main">
			...
			<h2>The forecast of the Marxism Journalism Lecture</h2>
			<div class="u-text">
				<h3>Speaker:</h3>
				<p> <strong>Xiangbin Liang</strong>
				</p>
				<h3>Time:</h3>
				<p>3:00p.m, 8th June</p>
				<h3>Time</h3>
				<p>Proper investigation is the basic skills of a good reporter</p>
				<h3>Location:</h3>
				<p>Multifunctional auditorium on the 3 floor.</p>
			</div>
		</div>
	</div>
</div>
